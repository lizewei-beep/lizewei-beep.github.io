...
import re
from tkinter import Tk, Label, StringVar, ttk, Button,Text,Entry
import urllib.parse
import os
import tkinter as tk
savePath = "C:\\Users\\123\\Downloads\\洛谷题目\\"
...
# 创建文本框
text_output = Text(window, width=100, height=30)  # 设置初始宽度和高度
text_output.grid(row=3, column=0, columnspan=2, padx=10, pady=10, sticky='w')
# 创建按钮
button = Button(window, text="搜索", command=fun)
# 设置按钮的位置
